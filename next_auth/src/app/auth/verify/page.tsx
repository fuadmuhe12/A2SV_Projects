        ...
        >
          <div className="flex flex-col gap-y-5">
            <div className="flex gap-x-9 pt-10">
              {code.map((num, index) => (
                <input
                  ...
                  className="h-[50px] caret-gray-400 caret w-[70px] bg-[#F8F8FD] rounded-md outline-[#4540de89] text-4xl font-medium text-center pt-0  outline-none placeholder:m-auto placeholder:font-medium placeholder:text-4xl placeholder:text-center pt-2"
                />
              ))}
            </div>
            {errorMessage && (
            ...
            <p className="text-center">
              ...
              in <br />
              <span className="font-semibold text-[#4540dec4]"> 0:30</span>{" "}
            </p>
          </div>
          <div className="pt-11">
